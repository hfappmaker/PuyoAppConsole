namespace TreeTest
{
    ...
    {
        private static IEnumerable<(int, int)> expected1 = new (int, int)[] { (0, 0), (1, 0), (2, 1), (1, 1), (2, 2) };
        private static IEnumerable<(int, int)> expected2 = new (int, int)[] { (0, 0), (1, 0), (2, 0), (2, 1), (1, 1), (2, 1), (2, 2) };
        ...
        public void TreeTest1()
        {
            ...
            Assert.Equal(string.Join(",", expected1), result.ToString());
        }
